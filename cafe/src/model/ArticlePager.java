...
public class ArticlePager {
	...
	private int endRow;
	// 게시글의 내용.
	private List<MemberBoard01> articleList;
	
	
	// 디버깅용 toString
	@Override
	public String toString() {
		return "ArticlePager [전체 게시글의 숫자=" + totalArticleCount + ", 전체 페이지 숫자=" + totalArticlePage
				+ ", 현재 페이지 =" + currentPageNum + ", 한 페이지에 보여줄 게시글 숫자(상수) =" + showPagePerArticle + ", 시작 게시글 번호 ="
				+ startRow + ", 마지막 게시글 번호 =" + endRow + ", 게시글의 내용 =" + articleList + "]";
	}

	// 생성자 공식
	public ArticlePager(int totalArticleCount, 
						int totalArticlePage, 
						int currentPageNum, 
						int showPagePerArticle,
						int startRow, 
						int endRow, 
						List<MemberBoard01> articleList) {
							this.totalArticleCount = totalArticleCount;
							this.totalArticlePage = totalArticlePage;
	...
	public List<MemberBoard01> getArticleList() {
		return articleList;
	}
}
